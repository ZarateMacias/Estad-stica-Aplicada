...
ggplot(bernoulli_data, aes(x = factor(x), y = probabilidad, fill = factor(x))) +
  ...
  facet_wrap(~p, ncol = 5) +
  scale_fill_manual(values = c("0" = "green", "1" = "blue")) +
...
ggplot(binomial_monedas, aes(x = Num_Caras, y = Probabilidad)) +
  geom_col(fill = "lightgray", alpha = 0.7, width = 0.8) +
...
ggplot(comp_p_data, aes(x = k, y = probabilidad)) +
  ...
  geom_vline(aes(xintercept = media), color = "red", linetype = "dashed") +
...
ggplot(medicina_data, aes(x = k, y = probabilidad)) +
  ...
  geom_vline(xintercept = c(18, 22), color = "green", linetype = "dotted", size = 1) +
